...
The categories cover an intentionally broad range so that your full life â€” not just your fitness â€” earns recognition:
...
Each one is something you might do anyway â€” but now, doing it leaves a mark.
...
Each category has a unique banner â€” illustrated, full-width, scaled for mobile and desktop â€” that only renders when the entire section is complete. It's a visual signal that you've gone the distance in that part of your life. Not a badge alongside the others â€” a transformation of the whole section into something that reads as *finished*.
...
When you unlock new achievements, you can tap "View Achievements" from the notification and arrive on a filtered view that highlights exactly what you just earned â€” the category, the badge, the description. Then a "View All Achievements" button returns you to the full picture.
